...
layui.define(function(exports){
  ...
  //字符常量
  ,MOD_NAME = 'ulaypage', DISABLED = 'layui-disabled'
  ...
  Class.prototype.view = function(){
    ...
    ,views = {
      ...
      //数据总数
      ,count: '<span class="layui-laypage-count">'+appLang.trans('共')+' '+ config.count  +appLang.trans('条')+'</span>'
      ...
      //跳页区域
      ,skip: function(){
        return ['<span class="layui-laypage-skip">'+appLang.trans('到第')
          ,'<input type="text" min="1" value="'+ config.curr +'" class="layui-input">'
          ,appLang.trans('页')+'<button type="button" class="layui-laypage-btn">'+appLang.trans('确定')+'</button>'
        ,'</span>'].join('');
      }()
    };
